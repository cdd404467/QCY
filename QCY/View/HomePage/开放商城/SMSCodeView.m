...
@property (nonatomic, strong) NSMutableArray<CursorLabel *> *labels;

@property (nonatomic, strong) NSMutableArray<UIView *> *lines;

@property (nonatomic, weak) CursorLabel *currentLabel;
...
//    self.lines = @[].mutableCopy;
    ...
    {
        CursorLabel *label = [CursorLabel new];
...
- (void)layoutSubviews
{
    ...
    for (NSInteger i = 0; i < self.labels.count; i++)
    {
        ...
        label.backgroundColor = HEXColor(@"#EEEEEE", 1);
...
- (void)cursor
{
    ...
    CursorLabel *label = [self.labels objectAtIndex:index];
...
- (void)setupView
{
    ...
    cursorView.backgroundColor = MainColor;
    cursorView.alpha = 0;
