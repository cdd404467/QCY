...
- (void)setupUI {
    ...
    [ztcBtn layoutWithEdgeInsetsStyle:ButtonEdgeInsetsStyleLeft imageTitleSpace:2.f];
    ...
    [ztcBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(0);
        make.left.mas_equalTo(signImageView.mas_right).offset(10);
        make.height.mas_equalTo(signImageView);
        make.width.mas_equalTo(KFit_W(88));
    }];
    _ztcBtn = ztcBtn;
    ...
    [personImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(0);
        make.left.mas_equalTo(ztcBtn.mas_right).offset(10);
...
- (void)setModel:(AskToBuyModel *)model {
    ...
    if (model.showInfo.integerValue == 1) {
        ...
        [_personImageView mas_remakeConstraints:^(MASConstraintMaker *make) {
            ...
            make.top.mas_equalTo(0);
            make.width.height.mas_equalTo(self.signImageView);
        }];
    } else {
        _ztcBtn.hidden = YES;
        [_personImageView mas_remakeConstraints:^(MASConstraintMaker *make) {
            make.left.mas_equalTo(self.signImageView.mas_right).offset(10);
            make.top.mas_equalTo(0);
            make.width.height.mas_equalTo(self.signImageView);
