...
@implementation Msg_CommentsCell
...
- (void)setModel:(FCMsgModel *)model {
    ...
    _contentLab.text = model.commentText;
...
+ (instancetype)cellWithTableView:(UITableView *)tableView {
    static NSString *identifier = @"Msg_CommentsCell";
    Msg_CommentsCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (cell == nil) {
        cell = [[Msg_CommentsCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
    }
