...
// 内容视图宽度
#define kTextWidth          (SCREEN_WIDTH - 65 - 15)
// 评论字体
#define kComTextFont        14.0
// 评论高亮字体
...
// 按住背景颜色
#define kHLBgColor          UIColor.lightGrayColor
// 图片间距
#define kImagePadding       5
// 图片宽度
#define kImageWidth         KFit_W(79)
// 全文/收起按钮高度
#define kMoreLabHeight      17
// 全文/收起按钮宽度
