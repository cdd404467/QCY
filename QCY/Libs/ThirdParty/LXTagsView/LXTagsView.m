...
-(void)buildTags{
    ...
    for (int i = 0; i<_dataA.count; i++) {
        ...
        UIButton *button =[UIButton LXButtonNoFrameWithTitle:_dataA[i] titleFont:self.tagFont Image:nil backgroundImage:nil backgroundColor:[UIColor whiteColor] titleColor:HEXColor(@"#666666", 1)];
...
-(void)layoutItems{
    ...
    CGFloat allWidth = _allWidth;//总宽度
