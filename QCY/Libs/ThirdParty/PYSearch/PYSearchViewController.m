...
#define PYRectangleTagMaxCol 10 // 矩阵标签时，最多列数
...
- (void)viewDidLoad {
    ...
    //注册监听，清空输入框内容
    static NSString *clear = @"clearText";
    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(clearSearchBarText) name:clear object:nil];
}
...
- (UILabel *)labelWithTitle:(NSString *)title
{
    ...
    label.backgroundColor = [UIColor py_colorWithHexString:@"#f6f6f6"];
