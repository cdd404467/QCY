...
@interface Msg_DianZanVC ()<UITableViewDataSource, UITableViewDelegate, FriendCircleDelegate>
@property (nonatomic, strong)UITableView *tableView;
@property (nonatomic, strong)NSMutableArray *dataSource;
@property (nonatomic, strong)UIButton *rightbBarButton;
@end

@implementation Msg_DianZanVC
...
- (void)requestData {
    NSString *urlString = [NSString stringWithFormat:URL_FC_DianZan_List,User_Token,self.pageNumber,Page_Count];
    DDWeakSelf;
...
- (void)deleteMsg:(NSInteger)index {
    ...
    self.rightbBarButton.enabled = NO;
    DDWeakSelf;
    [ClassTool postRequest:URL_DeleteMSG_Dianzan Params:[dict mutableCopy] Success:^(id json) {
        if ([json[@"code"] isEqualToString:@"SUCCESS"]) {
            weakself.rightbBarButton.enabled = YES;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    Msg_DianZanCell *cell = [Msg_DianZanCell cellWithTableView:tableView];
