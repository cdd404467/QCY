...
- (void)setupSubviews{
    ...
    if (KSGuaidManager.shouldDismissWhenDragging == NO) {
        ...
        self.dismissButton.backgroundColor = [UIColor colorWithRed:84/255.0 green:204/255.0 blue:84/255.0 alpha:1];
        self.dismissButton.layer.borderColor = [UIColor colorWithRed:84/255.0 green:204/255.0 blue:84/255.0 alpha:1].CGColor;
        [self.dismissButton setTitle:@"立即体验" forState:UIControlStateNormal];
        [self.dismissButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [self.dismissButton.titleLabel setFont:[UIFont systemFontOfSize:18]];
        self.dismissButton.frame = CGRectMake(0, 0, 200 ,50);
