...
@interface MyAskToBuyAcceptVC ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation MyAskToBuyAcceptVC
...
- (void)requestData {
    DDWeakSelf;
    NSString *urlString = [NSString stringWithFormat:URL_MYASK_BUY,GET_USER_TOKEN,@"3",_page,Page_Count];
    [CddHUD show];
