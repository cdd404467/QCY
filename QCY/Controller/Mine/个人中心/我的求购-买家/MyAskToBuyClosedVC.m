...
@interface MyAskToBuyClosedVC ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation MyAskToBuyClosedVC
...
- (void)requestData {
    DDWeakSelf;
    NSString *urlString = [NSString stringWithFormat:URL_MYASK_BUY,GET_USER_TOKEN,@"2",_page,Page_Count];
    [CddHUD show];
