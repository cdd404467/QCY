...
@interface MyAskToBuyWorkingVC ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation MyAskToBuyWorkingVC
...
- (void)requestData {
    DDWeakSelf;
    NSString *urlString = [NSString stringWithFormat:URL_MYASK_BUY,GET_USER_TOKEN,@"1",_page,Page_Count];
    [CddHUD show];
