...
@interface MyOfferPriceWorkingVC ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation MyOfferPriceWorkingVC
...
- (void)requestData {
    DDWeakSelf;
    NSString *urlString = [NSString stringWithFormat:URL_OFFER_LIST,GET_USER_TOKEN,@"0",_page,Page_Count];
    [CddHUD show];
