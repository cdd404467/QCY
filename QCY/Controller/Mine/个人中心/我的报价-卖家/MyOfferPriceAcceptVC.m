...
@interface MyOfferPriceAcceptVC ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation MyOfferPriceAcceptVC
...
- (void)requestData {
    DDWeakSelf;
    NSString *urlString = [NSString stringWithFormat:URL_OFFER_LIST,GET_USER_TOKEN,@"1",_page,Page_Count];
    [CddHUD show];
