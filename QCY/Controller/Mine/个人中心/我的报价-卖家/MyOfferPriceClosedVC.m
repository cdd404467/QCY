...
@interface MyOfferPriceClosedVC ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation MyOfferPriceClosedVC
...
- (void)requestData {
    DDWeakSelf;
    NSString *urlString = [NSString stringWithFormat:URL_OFFER_LIST,GET_USER_TOKEN,@"2",_page,Page_Count];
    [CddHUD show];
